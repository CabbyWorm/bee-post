...
const Trip = (() => {
  ...
  const legs = [
    ...
    { id: 'thu-centraal', mode: 'wander', label: 'Watching the trams',
      ...
      via: ['centraal', 'ijFerry', 'centraal', 'ijFerry', 'centraal'], weary: [1, 0.55], plump: [0.16, 0.26] },
    { id: 'thu-to-schiphol', mode: 'train', label: 'The train to Schiphol',
      ...
      via: ['centraal', 'schiphol'], weary: [0.55, 0.5], plump: [0.26, 0.26] },
    { id: 'thu-wait-ams', mode: 'wait', label: 'Schiphol, gate D',
      ...
      via: ['schiphol'], weary: [0.5, 0.4], plump: [0.26, 0.30] },
    { id: 'kl1033', mode: 'plane', label: 'KL1033, Amsterdam to Manchester',
      ...
      via: ['schiphol', 'manAirport'], weary: [0.4, 0.3], plump: [0.30, 0.30] },
    { id: 'thu-home', mode: 'home', label: 'Home for its dinner',
      ...
      via: ['manAirport', 'hive', 'manAirport'], weary: [0.3, 0.15], plump: [0.30, 0.42] },
    { id: 'kl1036', mode: 'plane', label: 'KL1036, Manchester to Amsterdam',
      ...
      via: ['manAirport', 'schiphol'], weary: [0.15, 0.25], plump: [0.42, 0.48] },
    { id: 'thu-into-town', mode: 'train', label: 'The train into town',
      ...
      via: ['schiphol', 'centraal'], weary: [0.25, 0.3], plump: [0.48, 0.48] },
    { id: 'thu-deliver', mode: 'wander', label: 'Finding your door',
      ...
      via: ['centraal', 'hotelDoor'], weary: [0.3, 0.3], plump: [0.48, 0.48] },
    { id: 'thu-sleep', mode: 'sleep', label: 'A bee hotel, in a park',
      ...
      via: ['hotelDoor', 'beeHotel'], weary: [0.5, 0.05], plump: [0.48, 0.50] },
    { id: 'fri-under-door', mode: 'wander', label: 'Under the door, quietly',
      ...
      via: ['beeHotel', 'hotelDoor'], weary: [0.05, 0.08], plump: [0.50, 0.50] },
    { id: 'fri-to-schiphol', mode: 'train', label: 'The first train to Schiphol',
      ...
      via: ['hotelDoor', 'centraal', 'schiphol'], weary: [0.08, 0.1], plump: [0.50, 0.50] },
    { id: 'fri-wait-ams', mode: 'wait', label: 'Schiphol, early',
      ...
      via: ['schiphol'], weary: [0.1, 0.1], plump: [0.50, 0.56] },
    { id: 'kl1029', mode: 'plane', label: 'KL1029, Amsterdam to Manchester',
      ...
      via: ['schiphol', 'manAirport'], weary: [0.1, 0.15], plump: [0.56, 0.56] },
    { id: 'fri-airport-train', mode: 'train', label: 'Airport to Piccadilly',
      ...
      via: ['manAirport', 'piccadilly'], weary: [0.15, 0.15], plump: [0.56, 0.56] },
    { id: 'avanti', mode: 'train', label: 'The 08:35 to Euston',
      ...
      via: ['piccadilly', 'stoke', 'milton', 'euston'], at: [0, 0.27, 0.72, 1], weary: [0.15, 0.25], plump: [0.56, 0.56] },
    { id: 'fri-walk', mode: 'walk', label: 'Round the corner to St Pancras',
      ...
      via: ['euston', 'stPancras'], weary: [0.25, 0.25], plump: [0.56, 0.56] },
    { id: 'eurostar', mode: 'eurostar', label: 'The 11:04 to Amsterdam',
      ...
      at: [0, 0.14, 0.19, 0.24, 0.29, 0.36, 0.48, 0.62, 0.82, 1], weary: [0.25, 0.55], plump: [0.56, 0.56] },
    { id: 'fri-town', mode: 'wander', label: 'The flower market, and the ferry again',
      ...
      via: ['centraal', 'hotelDoor', 'bloemenmarkt', 'ijFerry', 'bloemenmarkt'], weary: [0.55, 0.75], plump: [0.56, 0.66] },
    { id: 'fri-sleep', mode: 'sleep', label: 'The bee hotel, again',
      ...
      via: ['bloemenmarkt', 'beeHotel'], weary: [0.75, 0.05], plump: [0.66, 0.68] },
    { id: 'sat-deliver', mode: 'wander', label: 'Hand delivered',
      ...
      via: ['beeHotel', 'vondelpark', 'hotelDoor'], weary: [0.05, 0.15], plump: [0.68, 0.72] },
    { id: 'sat-morning', mode: 'wander', label: 'One more go on the ferry',
      ...
      via: ['hotelDoor', 'ijFerry', 'centraal', 'hotelDoor'], weary: [0.15, 0.3], plump: [0.72, 0.76] },
    { id: 'sat-bag-train', mode: 'bag', label: 'In the bag, on the train to Schiphol',
      ...
      via: ['hotelDoor', 'centraal', 'gate'], weary: [0.3, 0.3], plump: [0.76, 0.76] },
    { id: 'sat-gate', mode: 'bag', label: 'In the bag, at the gate',
      ...
      via: ['gate'], weary: [0.3, 0.25], plump: [0.76, 0.78] },
    { id: 'ezy2166', mode: 'plane', label: 'EZY2166, Amsterdam to Manchester', inTheBag: true,
      ...
      via: ['gate', 'manAirport'], weary: [0.25, 0.3], plump: [0.78, 0.78] },
    { id: 'home', mode: 'home', label: 'Back in the hedge',
      ...
      via: ['manAirport', 'hive'], at: [0, 0.002], weary: [0.3, 0.1], plump: [0.78, 0.80] },
