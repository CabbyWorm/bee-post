...
const Trip = (() => {
  ...
  const legs = [
    ...
    { id: 'thu-centraal', mode: 'wander', label: 'Watching the trams',
      ...
      via: ['centraal', 'ijFerry', 'centraal', 'ijFerry', 'centraal'], weary: [1, 0.35], plump: [0.16, 0.26] },
    { id: 'thu-to-schiphol', mode: 'train', label: 'The train to Schiphol',
      ...
      via: ['centraal', 'schiphol'], weary: [0.35, 0.3], plump: [0.26, 0.26] },
    { id: 'thu-wait-ams', mode: 'wait', label: 'Schiphol, gate D',
      ...
      via: ['schiphol'], weary: [0.3, 0.2], plump: [0.26, 0.30] },
    { id: 'kl1033', mode: 'plane', label: 'KL1033, Amsterdam to Manchester',
      ...
      via: ['schiphol', 'manAirport'], weary: [0.2, 0.12], plump: [0.30, 0.30] },
    ...
    { id: 'avanti', mode: 'train', label: 'The 08:35 to Euston',
      ...
      via: ['piccadilly', 'stoke', 'milton', 'euston'], at: [0, 0.27, 0.72, 1], weary: [0.12, 0.18], plump: [0.56, 0.56] },
    { id: 'fri-walk', mode: 'walk', label: 'Round the corner to St Pancras',
      ...
      via: ['euston', 'stPancras'], weary: [0.18, 0.18], plump: [0.56, 0.56] },
    { id: 'eurostar', mode: 'eurostar', label: 'The 11:04 to Amsterdam',
      ...
      at: [0, 0.14, 0.19, 0.24, 0.29, 0.36, 0.48, 0.62, 0.82, 1], weary: [0.18, 0.32], plump: [0.56, 0.56] },
    { id: 'fri-town', mode: 'wander', label: 'The flower market, and the ferry again',
      ...
      via: ['centraal', 'hotelDoor', 'bloemenmarkt', 'ijFerry', 'bloemenmarkt'], weary: [0.32, 0.6], plump: [0.56, 0.66] },
    ...
    { id: 'sat-morning', mode: 'wander', label: 'One more go on the ferry',
      ...
      via: ['hotelDoor', 'ijFerry', 'centraal', 'hotelDoor'], weary: [0.1, 0.22], plump: [0.72, 0.76] },
    { id: 'sat-bag-train', mode: 'bag', label: 'In the bag, on the train to Schiphol',
      ...
      via: ['hotelDoor', 'centraal', 'gate'], weary: [0.22, 0.2], plump: [0.76, 0.76] },
